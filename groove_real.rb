...
DESC = 'High accuracy BPM-to-groove converter.
Usage: ./groove_real.rb <bpm> [<option>...]
Options:
...
Examples:
- `./groove_real.rb 120` => `8 7`
- `./groove_real.rb 120 8 beat` => `4 4 4 3`
- `./groove_real.rb 150 45 hz` => `5 4`
- `./groove_real.rb 165 4 rows` => `6 5`
- `./groove_real.rb 170 8 max` => `6 5 5 6 5 5 5`'
